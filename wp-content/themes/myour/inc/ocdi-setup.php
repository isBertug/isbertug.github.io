...
function myour_ocdi_import_files() {
    return array(
        array(
            ...
            'import_file_url'            => MYOUR_EXTRA_PLUGINS_DIRECTORY . '/normal/ocdi-import/demo/01/content.xml',
            'import_preview_image_url'     => MYOUR_EXTRA_PLUGINS_DIRECTORY . '/normal/ocdi-import/demo/02/preview.jpg',
            'preview_url'                  => 'https://1.envato.market/c/1790164/275988/4415?u=https://themeforest.net/item/myour-one-page-resume-wordpress-theme/full_screen_preview/27319073',
        ),
        array(
            'import_file_name'             => esc_attr__( 'Default', 'myour' ),
            'categories'                   => array( esc_attr__( 'Main', 'myour' ) ),
            'import_file_url'            => MYOUR_EXTRA_PLUGINS_DIRECTORY . '/normal/ocdi-import/demo/01/content.xml',
            'import_preview_image_url'     => MYOUR_EXTRA_PLUGINS_DIRECTORY . '/normal/ocdi-import/demo/01/preview.jpg',
            'preview_url'                  => 'https://1.envato.market/c/1790164/275988/4415?u=https://themeforest.net/item/myour-one-page-resume-wordpress-theme/full_screen_preview/27319073',
        ),
    );
}
...
Wilson',
        ...
        'options_vcard_image' => 19,
        '_options_vcard_image' => 'field_5ed404ad72663',
        'options_footer_text' => '&copy; 2023 Myour all right reserved.',
    ...
    if( 'Light' === $selected_import['import_file_name'] ) {
        $ocdi_fields_to_change = array(
            ...
            'options_header_logo_img' => 163,
            '_options_header_logo_img' => 'field_5d11763c9ed10',
            'options_vcard_image' => 162,
            '_options_vcard_image' => 'field_5ed404ad72663',
